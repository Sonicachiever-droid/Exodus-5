...
struct MiniTVFrame: View {
    ...
    var body: some View {
        ...
        return ZStack {
                        ...
                        .fill(
                            RadialGradient(
                                gradient: Gradient(stops: [
                                    ...
                                    .init(color: Color(red: 0.98, green: 0.93, blue: 0.55), location: 0.25),
                                    .init(color: Color(red: 0.96, green: 0.89, blue: 0.35), location: 0.55),
                                    .init(color: Color(red: 0.88, green: 0.76, blue: 0.20), location: 0.85),
                                    .init(color: Color(red: 0.78, green: 0.62, blue: 0.12), location: 1.0)
                                ]),
                                center: .center,
                                startRadius: 0,
                                endRadius: 80
            ...
            Text(text)
                .font(.system(size: min(width, height) * fontScale * 0.5, weight: .bold, design: .default))
                .foregroundColor(useDarkScreen ? Color.white : Color.black)
                .shadow(color: useDarkScreen ? Color.white.opacity(0.4) : Color.clear, radius: 1, x: 0, y: 0)
                .lineLimit(1)
